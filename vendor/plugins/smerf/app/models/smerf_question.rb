...
class SmerfQuestion < SmerfItem
  ...
  attr_accessor :question_style, :answer_style, :question_id, :answer_id, :subfirst, :title
  ...
  def initialize(parent_id, sort_order_field)
    ...
    @fields = {
      ...
      'style'                       => {'mandatory' => 'N'},
      'question_style'              => {'mandatory' => 'N'},
      'answer_style'                => {'mandatory' => 'N'},
      'question_id'                 => {'mandatory' => 'N'},
      'answer_id'                   => {'mandatory' => 'N'},
      'additional'                  => {'mandatory' => 'N'},
      'tags'                        => {'mandatory' => 'N'},
      'subfirst'                    => {'mandatory' => 'N'},
      'title'                       => {'mandatory' => 'N'}
    }
  end    
