...
json.start_day      Time.zone.parse(SiteConfig.first.start_date.to_s).strftime('%Y-%m-%d')
json.num_days       SiteConfig.first.number_of_days
json.utc_offset     Time.zone.parse(SiteConfig.first.start_date.to_s).utc_offset/(60*60) # Time.zone.utc_offset/(60*60)
