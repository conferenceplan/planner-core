...
CKEDITOR.config.htmlbuttons = [
  {
    ...
    items : [
      ...
      {
        name:'published-first-name',
        //icon:'icon1.png',
        html:'<%= args[:person].pubFirstName %>',
        title:'Person\'s published first name'
      },
      {    
        name:'published-last-name',
        //icon:'icon2.png',
      ...
      {
          name:'schedule-assignments-with-emails',
          //icon:'icon2.png',
          html:'<%= assignments_with_emails_to_html(args[:assignments]) %>',
          title:'Person\'s Speaking Schedule with emails of co-participants'
      },
